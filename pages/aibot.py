...
st.title('重生之帮小夭选老公❤️💕❤️💕')
st.subheader("风吹到哪页看哪页，剧播到哪集嗑哪cp")
...
temp = "现在你要扮演一个的角色，你的性格是"+st.session_state.xingge+"，你只需要回答小夭的话即可，不需要重复用户的话，也不需要将你的角色和性格进行展示。现在说的话是:{input},你们的以前的对话是{history}"
